...
- 获取指定时间: `dt = datetime(2019, 12, 30, 20, 30)`

- datetime转timestamp: `t = dt.timestamp()`

- timestamp转datetime: `dt = datetime.fromtimestamp(t)`

- str转datetime: `cday = datetime.strptime('2015-6-1 18:19:59', '%Y-%m-%d %H:%M:%S')`

- datetime转str: `dt.strftime('%a, %b %d %H:%M')`
